...
Inspired by a distributive network able to cleanly target a memory and modify it, we investigated the current approaches of unlearning algorithms, Hopfield network associative memory storage, abstract models of latent cause theory that describe reconsolidation therapy, processes of hippocampal indexing like pattern completion and seperation, and adapted the 2023 unlearning competition metric to measure an attempt at a new classification unlearning algorithm with these components and compared against other approaches. All code can be found on \url{https://github.com/finger-tree/Reconsolidative-unlearning}
